...
Map<String, dynamic> product = {
  ...
  'image': null, // এখানে picked image থাকবে
...
└── models/
    └── product_model.dart # কোন database model নেই, শুধু Map ব্যবহার
```
